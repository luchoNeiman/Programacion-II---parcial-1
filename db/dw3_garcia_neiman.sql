...
(5, 2, 5, '2025-05-15', 'Llavero de Pikachu', 'Llavero metálico con diseño de Pikachu, ideal para fans de Pokémon.', 3500.00, 'llaveroPikachu.webp', 'Llavero de Pikachu', 'Fabricado en silicona y metal, incluye una figura 3D de Pikachu junto con una correa con el logo de Pokémon. Su anillo metálico es resistente y tiene un tamaño aproximado de 8 cm. Es suave al tacto e ideal para mochilas, llaves o bolsos.'),
(6, 2, 4, '2025-05-15', 'Coleccionable de Levi Ackerman', 'Figura articulada de Levi Ackerman con accesorios intercambiables.', 12000.00, 'leviAckerman.webp', 'Figura de Levi Ackerman', 'Tiene una altura de 10 cm y está fabricado en vinilo premium. Su estilo es chibi y representa a Levi en su versión de limpieza (Cleaning Levi). Incluye una caja ilustrada para colección, detalles pintados a mano y pertenece a la edición de coleccionista YouTooz.'),
(7, 2, 6, '2025-06-15', 'Buzo de My Hero Academia', 'Sudadera con capucha con diseño de la UA Academy.', 15999.00, 'buzoMyHeroAcademy.jpg', 'Sudadera de My Hero Academia', 'Está confeccionado en una mezcla de algodón y poliéster, con una estampa frontal que muestra personajes de la UA Academy (Deku, Todoroki, Bakugo). Tiene interior frizado, capucha con cordones ajustables, puños y cintura elastizados, y está disponible en talles S a XXL.'),
(8, 1, 4, '2025-05-15', 'Póster de Attack on Titan', 'Póster de alta calidad con diseño del Escuadrón de Reconocimiento.', 1399.00, 'posterAttackOnTitan.webp', 'Póster de Attack on Titan', 'Este póster de Attack on Titan muestra a Eren, Mikasa y Armin en una escena cargada de acción y dramatismo, ideal para fanáticos del anime. Está impreso en papel ilustración de alta calidad, con un acabado brillante que resalta los colores y detalles. Su diseño vibrante lo convierte en una excelente opción para decorar tu habitación, estudio o cualquier rincón otaku con estilo.'),
...
ALTER TABLE `productos`
  ...
  ADD KEY `fk_productos_usuarios1_idx` (`usuario_fk`),
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `fk_productos_usuarios1` FOREIGN KEY (`usuario_fk`) REFERENCES `usuarios` (`usuario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
