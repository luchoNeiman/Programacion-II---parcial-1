...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2025 a las 16:57:28
...
CREATE TABLE `compras_tienen_productos` (
  `compras_tienen_productoscol` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(6, 1, 4, '2025-05-15', 'Figura de Levi Ackerman', 'Figura articulada de Levi Ackerman con accesorios intercambiables.', 12000.00, 'leviAckerman.webp', 'Figura de Levi Ackerman', 'Tiene una altura de 10 cm y está fabricado en vinilo premium. Su estilo es chibi y representa a Levi en su versión de limpieza (Cleaning Levi). Incluye una caja ilustrada para colección, detalles pintados a mano y pertenece a la edición de coleccionista YouTooz.'),
...
(51, 2, 19, '2025-07-30', 'Muñeco de SSJ', '', 3242.00, NULL, '', '');
