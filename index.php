...
// Definición de rutas y sus títulos
$rutas = [
  'home' => ['titulo' => 'Página principal'],
  'productos' => ['titulo' => 'Productos'],
  'detalleProducto' => ['titulo' => 'Detalle Producto'],
  'contacto' => ['titulo' => 'Contacto'],
  'procesar-contacto' => ['titulo' => 'Procesar Formulario'],
  'ver-carrito' => ['titulo' => 'Carrito de compras'],
  'checkout' => ['titulo' => 'Checkout compra'],
  'Gracias' => ['titulo' => 'Finalizar compra'],
  'registrarse' => ['titulo' => 'Crear una cuenta'],
  'iniciar-sesion' => ['titulo' => 'Ingresar a mi cuenta'],
  'miPerfil' => [
    'titulo' => 'Mi Perfil',
...
// Obtiene la sección de la URL (GET) o usa "home" por defecto
$seccion = $_GET['seccion'] ?? 'home';

// Si la sección no existe en el array $rutas, carga la vista 404
if (!isset($rutas[$seccion])) {
  $seccion = '404';
}
$rutaConfig = $rutas[$seccion];

// Instancia de autenticación para manejar el login del usuario
$autenticacion = new Autenticacion;

// Captura mensajes de feedback y los elimina de la sesión
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse text-white" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <div class="nav-item dropdown">
                      <?php if ($autenticacion->estaAutenticado()): ?>
                        ...
                        <?php $usuario = $autenticacion->getUsuarioLogin(); ?>
                          <a class="nav-link dropdown-toggle d-flex align-items-center text-white fs-5"
                      ...
                      <?php else: ?>
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                              <li><a href="index.php?seccion=iniciar-sesion" class="dropdown-item fs-5">Iniciar
                                      sesión</a></li>
                              <li><a href="index.php?seccion=registrarse" class="dropdown-item fs-5">Registrarse</a>
                              </li>
                          </ul>
                      <?php endif; ?>
                    </div>
                    ...
                    <a class="nav-link active text-white fs-5" href="index.php?seccion=home">
                    ...
                    <!-- Acceso al panel admin solo si es administrador -->
                  <?php $usuario = $autenticacion->getUsuarioLogin(); ?>
                  <?php if ($autenticacion->estaAutenticado() && $usuario->getRolFk() === Usuario::ROL_ADMIN): ?>
...
<main class="pt-5 bg-degrade">
  <?php
  // Carga la vista correspondiente a la sección seleccionada
