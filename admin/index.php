...
$rutas = [
  ...
  'miPerfil' => ['titulo' => 'Mi Perfil', 'requiereAutenticacion' => false],

  'productos' => ['titulo' => 'Administrar productos', 'requiereAutenticacion' => true],
  'nuevoProducto' => ['titulo' => 'Nuevo Producto', 'requiereAutenticacion' => true],
  'edicionProducto' => ['titulo' => 'Editar producto', 'requiereAutenticacion' => true],
  'verProducto' => ['titulo' => 'Ver producto', 'requiereAutenticacion' => true],
  'confirmarBajaProducto' => ['titulo' => 'Confirmacion de baja de producto', 'requiereAutenticacion' => true],

  'registroUsuarios' => ['titulo' => 'Administrar usuarios', 'requiereAutenticacion' => true],
  'verCompras' => ['titulo' => 'Ver compras', 'requiereAutenticacion' => true],
...
// ====== Feedbacks (flash messages) ======
// Levanta feedback de éxito si existe y lo limpia de sesión
if (isset($_SESSION['feedback_exito'])) {
  $feedbackExito = $_SESSION['feedback_exito'];
  unset($_SESSION['feedback_exito']);
}
// Levanta feedback de error si existe y lo limpia de sesión
...
<html lang="es">
<head>
    <!-- Meta y título dinámico por sección -->
    <meta charset="UTF-8">
                  ...
                  <div class="navbar-nav ms-auto">
                      ...
                      <div class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                              <li>
                                  <!-- Link a perfil dentro del admin -->
...
<!-- Auto-ocultar feedbacks a los 5s con un fade-out simple -->
<script>
    setTimeout(() => {
