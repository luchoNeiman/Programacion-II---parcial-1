...
<section class="container mt-5 mb-5">
    ...
    <form action="acciones/crearProducto.php" method="post" enctype="multipart/form-data">
        <div class="card shadow">
            ...
            <div class="card-body py-4">
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <?php if (isset($errores['titulo'])): ?>
                          <div class="msg-error" id="error-titulo">
                              <i class="bi bi-exclamation-circle-fill text-danger me-3"></i><?= $errores['titulo']; ?>
                          </div>
                      <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="precio" class="form-label text-violeta">Precio
                            <span class="colorRequiaried">*
                        </label>
                        <input type="number" step="0.01" name="precio" id="precio" class="form-control mb-3"
                               placeholder="0.00"
                    ...
                    <div class="col-md-12">
                        <label for="descripcion" class="form-label text-violeta mt- ">Descripción</label>
        ...
        <div class="card shadow mt-5">
            ...
            <div class="card-body py-4">
                <div class="row">
                    <div class="col-md-6">
                        <label for="categorias" class="form-label text-violeta">Seleccioná las categorías
