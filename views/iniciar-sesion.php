          ...
          <?php endif; ?>
            <form action="acciones/procesar_iniciar-sesion.php" method="POST" class="card shadow p-4 border-0"
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control <?php if (isset($errores['email'])) echo 'is-invalid'; ?>"
                           id="email" name="email" value="<?= htmlspecialchars($email) ?>" required autofocus>
                ...
                <small class="mt-1">
                    ¿No tienes cuenta? <a class="text-decoration-none " href="index.php?seccion=registrarse"><strong
                                class="text-violeta">Regístrate</strong></a>
                </small>
            </form>
        </div>
    </div>
