...
<section class="container my-5 " >
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6">
            <h1 class="display-6 mb-3 text-white"><?= htmlspecialchars($producto->getTitulo()); ?></h1>
            <p class="lead text-white"><?= htmlspecialchars($producto->getDescripcion()); ?></p>
            ...
            <div class="card p-3 -sm detalle-caracteristicas-producto">
                <div class="container">
                    ...
                    <ul class="list-unstyled text-color">
                        <li><?= htmlspecialchars($producto->getCaracteristicas()) ?></li>
