            ...
            <form action="acciones/crear-cuenta.php" method="POST" class="card shadow p-4 border-0" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="email"
                           ...
                           id="emailconfirmed" name="emailconfirmed" required autofocus
                ...
                <small class="mt-1">
                    ¿ya tienes cuenta? <a class="text-decoration-none" href="index.php?seccion=iniciar-sesion"><strong
                                class="text-violeta">Iniciar sesión</strong></a>
                </small>
            </form>
        </div>